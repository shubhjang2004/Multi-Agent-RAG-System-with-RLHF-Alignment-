...
for query in tqdm(test_queries, desc="Generating"):
    ...
    results['ppo'].append(generate_response(query, ppo_model, ppo_tokenizer))
...
print(f"\n{'Metric':<20} {'Base':<15} {'SFT':<15} {'PPO':<15}")
print("-" * 80)

# ROUGE-1
print(f"{'ROUGE-1':<20} {evaluation_results['base']['rouge']['rouge1']:<15.4f} {evaluation_results['sft']['rouge']['rouge1']:<15.4f} {evaluation_results['ppo']['rouge']['rouge1']:<15.4f}")

# ROUGE-L
print(f"{'ROUGE-L':<20} {evaluation_results['base']['rouge']['rougeL']:<15.4f} {evaluation_results['sft']['rouge']['rougeL']:<15.4f} {evaluation_results['ppo']['rouge']['rougeL']:<15.4f}")

# BERTScore
print(f"{'BERTScore F1':<20} {evaluation_results['base']['bertscore']['f1']:<15.4f} {evaluation_results['sft']['bertscore']['f1']:<15.4f} {evaluation_results['ppo']['bertscore']['f1']:<15.4f}")

# Length
print(f"{'Avg Length (words)':<20} {evaluation_results['base']['length']['mean_length']:<15.1f} {evaluation_results['sft']['length']['mean_length']:<15.1f} {evaluation_results['ppo']['length']['mean_length']:<15.1f}")
